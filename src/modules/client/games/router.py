...
from src.models import Game, Basket, OccupiedDateTime, BasketItem
...
@client_games.get('/featured', response_model=List[GameSchema], description=
                  """Отдает 3 игры которые не находятся в корзине, сортирует по кол-во продаж asc""")
